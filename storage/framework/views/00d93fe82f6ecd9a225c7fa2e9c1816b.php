...
<?php foreach($attributes->onlyProps(['title' => __('Passwort bestätigen'), 'content' => __('Aus Sicherheitsgründen bestätige bitte dein Passwort, um fortzufahren.'), 'button' => __('Confirm')]) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
<?php $attributes = $attributes->exceptProps(['title' => __('Passwort bestätigen'), 'content' => __('Aus Sicherheitsgründen bestätige bitte dein Passwort, um fortzufahren.'), 'button' => __('Confirm')]); ?>
<?php foreach (array_filter((['title' => __('Passwort bestätigen'), 'content' => __('Aus Sicherheitsgründen bestätige bitte dein Passwort, um fortzufahren.'), 'button' => __('Confirm')]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
} ?>
...
<?php if (! $__env->hasRenderedOnce('53327fe7-49f5-4265-baf9-3cef54a658b8')): $__env->markAsRenderedOnce('53327fe7-49f5-4265-baf9-3cef54a658b8'); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingPassword']); ?>
     ...
     <?php $__env->slot('content', null, []); ?> 
        ...
        <div class="mt-4" x-data="{}" x-on:confirming-password.window="setTimeout(() => $refs.confirmable_password.focus(), 250)">
            <?php if (isset($component)) { $__componentOriginal71c6471fa76ce19017edc287b6f4508c = $component; } ?>
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.input','data' => ['type' => 'password','class' => 'mt-1 block w-3/4','placeholder' => ''.e(__('Passwort')).'','autocomplete' => 'current-password','xRef' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'password','class' => 'mt-1 block w-3/4','placeholder' => ''.e(__('Passwort')).'','autocomplete' => 'current-password','x-ref' => 'confirmable_password','wire:model.defer' => 'confirmablePassword','wire:keydown.enter' => 'confirmPassword']); ?>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hr-software-3\resources\views/components/confirms-password.blade.php ENDPATH**/ ?>