...
<div class="py-12">
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4">
            ...
            <?php if($isModalOpen): ?>
                <?php echo $__env->make('livewire.user.timerecording-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
            <?php endif; ?>
        </div>
        <div class="columns-1 mt-5">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg px-4 py-4 mb-4">
                ...
                <table class="table-fixed w-full">
                    ...
                    <tbody>
                        <?php $__currentLoopData = $calendar_rows; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php if($r['isWeekHeader']): ?>
                                <tr style="background-color: rgb(189, 189, 189);">
                                    <td class="border px-4 py-2">KW <?php echo e($r['week']); ?></td>
                                    <td class="border px-4 py-2"></td>
                                    <td class="border px-4 py-2"></td>
                                    <td class="border px-4 py-2"><?php echo e($r['weekDuration']); ?></td>
                                    <td class="border px-4 py-2"></td>
                                    <td class="border px-4 py-2"></td>
                                </tr>
                            <?php else: ?>
                                <tr>
                                    <td class="border px-4 py-2"><?php echo e($r['day']); ?></td>
                                    <td class="border px-4 py-2"><?php echo e($r['start_time']); ?></td>
                                    <td class="border px-4 py-2"><?php echo e($r['end_time']); ?></td>
                                    <td class="border px-4 py-2"><?php echo e($r['duration']); ?></td>
                                    <td class="border px-4 py-2"><?php echo e($r['status']); ?></td>
                                    <td class="border px-4 py-2">
                                        <?php if($r['editable']): ?>
                                            <?php if(($user->id === \Auth::user()->id && (App\Http\Controllers\PermissionController::authUserHas('user_self_timerecording_edit_request') || App\Http\Controllers\PermissionController::authUserHas('user_self_timerecording_edit'))) || ($user->id !== \Auth::user()->id && (App\Http\Controllers\PermissionController::authUserHas('user_other_timerecording_edit_request') || App\Http\Controllers\PermissionController::authUserHas('user_other_timerecording_edit')))): ?>
                                                <button wire:click="edit(<?php echo e($r['timeRecordingId']); ?>)"><i class="fa-solid fa-pen"></i></button>
                                            <?php endif; ?>
                                            <?php if(($user->id === \Auth::user()->id && App\Http\Controllers\PermissionController::authUserHas('user_self_timerecording_delete')) || ($user->id !== \Auth::user()->id && App\Http\Controllers\PermissionController::authUserHas('user_other_timerecording_delete'))): ?>
                                                <button wire:click="delete(<?php echo e($r['timeRecordingId']); ?>)"><i class="fa-solid fa-trash"></i></button>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    </td>
                                </tr>
...
<?php /**PATH C:\xampp\htdocs\hr-software-3\resources\views/livewire/user/timerecording.blade.php ENDPATH**/ ?>