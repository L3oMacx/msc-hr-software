...
<?php $component->withAttributes([]); ?>
     <?php $__env->slot('title', null, []); ?> 
        <?php echo e(__('Browser-Sitzungen')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('description', null, []); ?> 
        <?php echo e(__('Verwalte und melde dich von deinen aktiven Sitzungen auf anderen Browsern und Geräten ab.')); ?>

     <?php $__env->endSlot(); ?>

     <?php $__env->slot('content', null, []); ?> 
        <div class="max-w-xl text-sm text-gray-600">
            <?php echo e(__('Falls nötig, kannst du dich von allen anderen Browser-Sitzungen auf all deinen Geräten abmelden. Hier sind einige deiner kürzlichen Sitzungen aufgelistet; jedoch ist diese Liste möglicherweise nicht vollständig. Wenn du den Verdacht hast, dass dein Konto kompromittiert wurde, solltest du auch dein Passwort aktualisieren.')); ?>
                    ...
                    <div class="flex items-center">
                        ...
                        <div class="ml-3">
                            <div class="text-sm text-gray-600">
                                <?php echo e($session->agent->platform() ? $session->agent->platform() : __('Unbekannt')); ?> - <?php echo e($session->agent->browser() ? $session->agent->browser() : __('Unbekannt')); ?>
...
<?php $component->withAttributes(['wire:click' => 'confirmLogout','wire:loading.attr' => 'disabled']); ?>
                <?php echo e(__('Melde dich von anderen Browser-Sitzungen ab.')); ?>
...
<?php $component->withAttributes(['wire:model' => 'confirmingLogout']); ?>
             ...
             <?php $__env->slot('content', null, []); ?> 
                <?php echo e(__('Bitte gib dein Passwort ein, um zu bestätigen, dass du dich von allen anderen Browser-Sitzungen auf all deinen Geräten abmelden möchtest.')); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH C:\xampp\htdocs\hr-software-3\resources\views/profile/logout-other-browser-sessions-form.blade.php ENDPATH**/ ?>