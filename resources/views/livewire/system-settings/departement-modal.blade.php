                ...
                <div class="bg-white px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                    <div class="">
                        <div class="mb-4">
                            ...
                            @error('departement_friendly_name') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <select
                                ...
                                @foreach ($all_users as $user)
                                    <option value="{{ $user->id }}">{{ $user->get('fullname')->value }}</option>
                                @endforeach
                            </select>
                            @error('departement_head') <span class="text-red-500">{{ $message }}</span>@enderror
                        </div>
                    </div>
                </div>
